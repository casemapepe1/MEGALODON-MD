...
module.exports = {
    ...
    SESSION_ID: process.env.SESSION_ID || "MEGALODON~MD~lUJXlIiY#ga-fPRTpMmOEWEh3v8V4i1lJK0KR0yc9jeD9TG-1h5A",  // Your bot's session ID (keep it secure)
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "50933693390",  // Owner's WhatsApp number
